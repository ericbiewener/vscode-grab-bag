...
const Subsume = __webpack_require__(/*! subsume */ "./node_modules/subsume/index.js");
const macosVersion = __webpack_require__(/*! macos-version */ "./node_modules/macos-version/index.js");
...
/*!*********************!*\
  !*** ./src/jest.ts ***!
  \*********************/
/*! exports provided: openCorrespondingTestFile, openCorrespondingSnapshot */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _iterm_jxa__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./iterm.jxa */ "./src/iterm.jxa.ts");
...
async function openCorrespondingTestFile() {
  ...
  const filenameParts = path__WEBPACK_IMPORTED_MODULE_1___default.a.basename(filepath).split('.');
  ...
  if (lodash_last__WEBPACK_IMPORTED_MODULE_0___default()(filenameParts) === 'snap') {
    ...
    filepathToShow = path__WEBPACK_IMPORTED_MODULE_1___default.a.join(dir, '__tests__', filenameParts.join('.'));
    testFilepath = filepathToShow;
  }

  console.log(vscode__WEBPACK_IMPORTED_MODULE_2__["workspace"].workspaceFolders[0].uri.fsPath);
  return Promise.all([Object(_utils__WEBPACK_IMPORTED_MODULE_4__["showTextDocument"])(filepathToShow, true), Object(_iterm_jxa__WEBPACK_IMPORTED_MODULE_3__["runJestTestInIterm"])(vscode__WEBPACK_IMPORTED_MODULE_2__["workspace"].workspaceFolders[0].uri.fsPath, testFilepath)]);
}
...
/*!**********************!*\
  !*** ./src/utils.ts ***!
  \**********************/
/*! exports provided: isFile, showTextDocument */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
