...
/***/ "./src/codemods/addReturnToArrowFunction.ts":
/*!**************************************************!*\
  !*** ./src/codemods/addReturnToArrowFunction.ts ***!
  \**************************************************/
/*! exports provided: addReturnToArrowFunction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addReturnToArrowFunction", function() { return addReturnToArrowFunction; });
...
/* harmony import */ var _parseText__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parseText */ "./src/codemods/parseText.ts");
...
function findInnerArrowFns(node, offset) {
  ...
  if (node.start >= offset || node.end < offset) return results;
  ...
  if (node.expression) findInnerArrowFns(node.expression.arguments, offset, results); // JSX

  if (node.openingElement) findInnerArrowFns(node.openingElement.attributes, offset, results);
  if (lodash_isObject__WEBPACK_IMPORTED_MODULE_0___default()(node.value)) findInnerArrowFns(node.value.expression, offset, results);
  return results;
}

/***/ }),

/***/ "./src/codemods/parseText.ts":
/*!***********************************!*\
  !*** ./src/codemods/parseText.ts ***!
  \***********************************/
/*! exports provided: parseActiveDocument */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseActiveDocument", function() { return parseActiveDocument; });
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! path */ "path");
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _babel_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/parser */ "./node_modules/@babel/parser/lib/index.js");
...
function parseActiveDocument() {
  ...
  var ast = _babel_parser__WEBPACK_IMPORTED_MODULE_2__["parse"](document.getText(), {
    ...
    // @ts-ignore
    errorRecovery: true,
    plugins: [typePlugin, 'jsx', 'asyncGenerators', 'bigInt', 'classProperties', 'classPrivateProperties', 'classPrivateMethods', // 'decorators',
    'doExpressions', 'dynamicImport', 'exportDefaultFrom', 'exportNamespaceFrom', 'functionBind', 'functionSent', 'importMeta', 'logicalAssignment', 'nullishCoalescingOperator', 'numericSeparator', 'objectRestSpread', 'optionalCatchBinding', 'optionalChaining', 'partialApplication', // 'pipelineOperator',
